...
import com.ccnu.counter.api.dto.CountsResponse;
...
public class CounterController {
    ...
    public ResponseEntity<CountsResponse> getCounts(@PathVariable("etype") String entityType,
        ...
        if (metricsStr == null || metricsStr.isBlank()) {
            ...
            metrics = Arrays.stream(metricsStr.split(",")).map(String::trim)
                    .filter(CounterSchema.SUPPORTED_METRICS::contains).toList();
        }
